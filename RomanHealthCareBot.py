...
def main(args):
    ...
    d = DiagnosisClient(username="Rd23Y_GMAIL_COM_AUT",language="en-gb",healthServiceUrl="https://healthservice.priaid.ch",authServiceUrl="https://authservice.priaid.ch/login",password="m3M4KxPa98QjDp6i5")
    ...
    if int(option) == 2:
        ...
        if do:
            ...
            issues = {"Message":"I could not diagnose by the entered symptoms."}
